...
const OpenEditProduct = ({ close, datas, fetchProducts }) => {
  ...
  const formSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        sweetAlert({ text: "Data Updated Successfully", title: "Updated" });
        setData({});
        close();
        fetchProducts();
      }
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 z-50 flex flex-row items-center justify-center py-4 overflow-hidden bg-black bg-opacity-45 ">
      <div className="w-full h-full max-w-lg m-2 mb-24 overflow-auto bg-white mt-28 lg:mt-28 scrollbar-none">
        ...
        <div className="p-[0.5px] bg-slate-400 mx-1 my-1"></div>
        ...
        <div className="p-3 bg-white">
          <form onSubmit={formSubmit} className="grid w-full gap-2">
            ...
            <div></div>
            <button
              className="py-1 text-xl bg-orange-500 rounded"
              type="submit"
            >
              Update
            </button>
