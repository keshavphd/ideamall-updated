...
const OpenNewCategory = ({ close, fetchCategory }) => {
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center w-full px-1 rounded bg-neutral-700 bg-opacity-45">
      <div className="flex flex-col w-full max-w-lg p-2 bg-white rounded">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <button
            ...
            } justify-center w-full mt-4 lg:mt-2 ${!(data.image && data.name) ? "cursor-not-allowed":"cursor-pointer "} p-1.5 text-center  rounded`}>
            {submitLoading ? "adding to category..." : "Add Category"}
          </button>
        </form>
      </div>
    </div>
